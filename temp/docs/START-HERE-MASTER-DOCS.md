...
### Main Document
**File:** `temp/docs/MIRIX-TECHNICAL-REFERENCE.md`
...
# Or in browser
markdown-preview temp/docs/MIRIX-TECHNICAL-REFERENCE.md
```

### Summary Document
**File:** `temp/docs/2025-11-18-MASTER-DOCUMENTATION-SUMMARY.md`
...
**Check existing docs:**
- `temp/docs/` folder has 35+ supporting documents
...
→ **Open: `temp/docs/MIRIX-TECHNICAL-REFERENCE.md`**
