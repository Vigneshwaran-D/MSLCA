...
- `temp/docs/2025-11-17-gemini-integration.md` - Gemini guide
- `temp/docs/2025-11-17-chat-integration.md` - Chat integration docs
- `temp/docs/2025-11-17-quick-start.md` - Quick start guide
- `temp/scripts/verify_chat_table.py` - DB verification script
...
All documentation available in `temp/docs/`:
