...
```bash
cd C:\Projects\MIRIX
python temp/scripts/generate_synthetic_test_data.py --org-id 1234 --user-id user-d1850539 --episodic 100 --chat 50
```

### Generate for Different User

```bash
python temp/scripts/generate_synthetic_test_data.py --org-id 1234 --user-id user-00000002
```
...
**Just double-click:** `temp/scripts/SETUP-AND-LAUNCH.bat`
