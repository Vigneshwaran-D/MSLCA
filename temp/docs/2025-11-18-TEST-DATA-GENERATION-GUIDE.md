...
```bash
# User 1
python temp/scripts/generate_synthetic_test_data.py --org-id 1234 --user-id user-00000001

# User 2
python temp/scripts/generate_synthetic_test_data.py --org-id 1234 --user-id user-00000002

# User 3
python temp/scripts/generate_synthetic_test_data.py --org-id 1234 --user-id user-00000003
```
