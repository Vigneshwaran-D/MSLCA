...
class SemanticMemoryManager:
    ...
    def _apply_temporal_scoring(
        self,
        scored_memories: List[Tuple[float, SemanticMemoryItem]],
        session: Session,
        limit: int,
    ...
    @enforce_types
    def update_item(
        self, item_update: SemanticMemoryItemUpdate, actor: PydanticUser
    ) -> PydanticSemanticMemoryItem:
    ...
    def create_many_items(
        self, items: List[PydanticSemanticMemoryItem], actor: PydanticUser
            ...
            if query == "":
                ...
                if search_method == "embedding":
                    ...
                    if settings.mirix_pg_uri_no_default:
                        ...
                        semantic_items = self._apply_temporal_scoring(
